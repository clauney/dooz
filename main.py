...
@app.route('/todo-<who>')
def todo(who):
  return '<HTML><br>'+get_todo_msg(who.title())+'<br><br>'+meteo+'</HTML>'
...
weatherwidget='''<a class="weatherwidget-io" href="https://forecast7.com/en/47d69n122d38/98117/?unit=us" data-label_1="BALLARD" data-label_2="WEATHER" data-theme="weather_one" >BALLARD WEATHER</a>
<script>
...
def get_todo_msg(who):
  listostuff=todonow(who.title(),daypart()[0])
  prettylist=''
  for item in listostuff:
    prettylist=prettylist+'<br>'+item[3]+': '+item[4]
  return 'Hello, '+who.title()+'!<br>Have you done this stuff this '+daypart()[1]+'?<br>'+prettylist

def todonow(person,ampm):
  personalizedtasks=[]
